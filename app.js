...
const mobileNumberPattern= /^[6-9]\d{8}$/
const passwordPattern = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[A-Za-z\d]{8,}$/
const pinPattern = /^[6-9]\d{4}$/
...
function regexTestSignInUserName(){
    signinText.addEventListener('keydown',()=>{
...
function regexTestSignInPassword(){
    signinPassword.addEventListener('keydown',()=>{
...
function regexTestSignUpUserName(){
    signupText.addEventListener('keydown',()=>{
...
function regexTestSignUpPassword(){
    signupPassword.addEventListener('keydown',()=>{
...
function regexTestSignUpConfirmPassword(){
    signupConfirmPassword.addEventListener('keydown',()=>{
...
function regexTestSignUpMobileNumber(){
    signupNumber.addEventListener('keydown',()=>{
...
function regexTestSignUpPin(){
    signupPin.addEventListener('keydown',()=>{
...
// !function regexTestSignUpUserName(element,data,constant){
